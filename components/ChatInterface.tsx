...
export default function ChatInterface({
  ...
  return (
    <main className="flex flex-col h-screen bg-gray-900 text-white">
      ...
      <footer className="bg-gray-800 p-0">
        <form onSubmit={handleSubmit} className="w-full mx-auto relative px-4">
          <div className="relative flex items-center w-full">
            <input
              ...
              className="flex-1 py-3 px-4 rounded-2xl border mb-6 border-gray-600 bg-gray-700 text-white placeholder-gray-400 pr-12 w-full"
              disabled={isLoading}
            />
            <Button
              type="submit"
              disabled={isLoading || !input.trim()}
              className="absolute right-1.5 mb-6 rounded-xl h-9 w-9 flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white"
            >
              <ArrowUpFromDot />
            </Button>
          </div>
